package com.mall.orderservice.config.base;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30) // open api spec 3.0
                ...
                .apis(RequestHandlerSelectors.basePackage("com.mall.orderservice.process.order.controller"))
    ...
    private ApiInfo apiInfo() {
        final String title = "order-service";
        final String description = "order-service guide book";
