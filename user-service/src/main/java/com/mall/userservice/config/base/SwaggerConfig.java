 ...
 * http://localhost:59994/swagger-ui/index.html
 */
@Configuration
@Profile({"!live"})
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        final String title = "user-service";
        final String description = "user-service guide book";
    ...
    private SecurityContext securityContext() {
        return SecurityContext.builder()
                ...
                .operationSelector(oc -> !(oc.requestMappingPattern().equals("/login") ||
                        oc.requestMappingPattern().equals("/register") ||
                        oc.requestMappingPattern().startsWith("/public/"))  )
